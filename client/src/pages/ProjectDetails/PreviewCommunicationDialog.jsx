...
import { Dialog, DialogSurface, DialogBody, DialogTitle, DialogContent, DialogActions, Button, Field, Input, Spinner } from '@fluentui/react-components';
...
export default function PreviewCommunicationDialog({ open, onOpenChange, project, currentForm }) {
  ...
  async function handleSend() {
    ...
    setSending(true);
    try {
      const res = await api.post(`/projects/${project._id}/send-communication`, { to, cc });
